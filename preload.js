...
contextBridge.exposeInMainWorld("aiBridge", {
  ...
  setGoogleOauthClientId: (clientId) => ipcRenderer.invoke("settings:setGoogleOauthClientId", clientId),
  setGoogleOauthClientSecret: (clientSecret) => ipcRenderer.invoke("settings:setGoogleOauthClientSecret", clientSecret),
  setGoogleOauthScopes: (scopes) => ipcRenderer.invoke("settings:setGoogleOauthScopes", scopes),
  disconnectGoogleOauth: () => ipcRenderer.invoke("settings:disconnectGoogleOauth"),
  clearGoogleOauthClient: () => ipcRenderer.invoke("settings:clearGoogleOauthClient"),
  googleOauthConnect: (options) => ipcRenderer.invoke("settings:googleOauthConnect", options),
  ...
  agentFindElements: (payload) => ipcRenderer.invoke("agent:findElements", payload),
  agentReadElement: (payload) => ipcRenderer.invoke("agent:readElement", payload),
  agentCollectLinks: (payload) => ipcRenderer.invoke("agent:collectLinks", payload),
  agentExtractStructuredData: (payload) => ipcRenderer.invoke("agent:extractStructuredData", payload),
  agentReaderExtract: (payload) => ipcRenderer.invoke("agent:readerExtract", payload),
  agentNetworkGetResponses: (payload) => ipcRenderer.invoke("agent:networkGetResponses", payload),
  agentCookieExport: (payload) => ipcRenderer.invoke("agent:cookieExport", payload),
  agentCookieImport: (payload) => ipcRenderer.invoke("agent:cookieImport", payload),
  agentGoogleSheetsAppendRows: (payload) => ipcRenderer.invoke("agent:googleSheetsAppendRows", payload),
  agentGoogleDocsCreateOrAppend: (payload) => ipcRenderer.invoke("agent:googleDocsCreateOrAppend", payload),
  agentGoogleSlidesCreateDeck: (payload) => ipcRenderer.invoke("agent:googleSlidesCreateDeck", payload),
  agentScrollIntoView: (payload) => ipcRenderer.invoke("agent:scrollIntoView", payload),
  ...
  agentFillText: (payload) => ipcRenderer.invoke("agent:fillText", payload),
  agentHotkey: (payload) => ipcRenderer.invoke("agent:hotkey", payload),
  ...
  agentWaitFor: (payload) => ipcRenderer.invoke("agent:waitFor", payload),
  agentDownloadsWait: (payload) => ipcRenderer.invoke("agent:downloadsWait", payload),
  agentExportFile: (payload) => ipcRenderer.invoke("agent:exportFile", payload),
